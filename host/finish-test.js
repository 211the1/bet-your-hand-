...
#host-test-winner-slot{position:absolute;left:47.5%;top:55.5%;transform:translate(-50%,-50%);width:clamp(150px,24vw,300px);height:clamp(220px,38vw,420px);display:flex;flex-direction:column;align-items:center;justify-content:flex-start;pointer-events:none}
