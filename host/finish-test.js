...
/* Winner slot: test Bug seated deeper into the center chair, moved up 10%. */
#host-test-winner-slot{position:absolute;left:47.5%;top:49%;transform:translate(-50%,-50%);width:clamp(130px,20vw,250px);height:clamp(190px,32vw,360px);display:flex;flex-direction:column;align-items:center;justify-content:flex-start;pointer-events:none}
