...
function renderHostFinishScreen(game){
  ...
  const columns=['7.5%','27.5%','47.5%','67.5%','87.5%'];
  ...
  overlay.innerHTML='<div class="host-finish-art-lock" style="position:relative!important;width:100%!important;height:100%!important;inset:0!important;overflow:hidden!important;">'+
    ...
    scores.slice(0,5).map((p,i)=>{
      ...
      return '<div class="host-finish-slot" data-slot="'+i+'" style="position:absolute!important;left:'+columns[i]+'!important;top:77.9%!important;width:10%!important;height:16%!important;margin:0!important;padding:0!important;box-sizing:border-box!important;text-align:center!important;overflow:visible!important;pointer-events:none!important;">'+
        '<div class="host-finish-photo-slot" style="position:absolute!important;left:50%!important;top:0!important;transform:translateX(-50%)!important;width:82%!important;height:43%!important;overflow:hidden!important;border-radius:5%!important;box-sizing:border-box!important;">'+
        ...
        '</div>'+
        '<div class="host-finish-score-slot" style="position:absolute!important;left:50%!important;top:50%!important;transform:translateX(-50%)!important;width:82%!important;height:25%!important;display:flex!important;align-items:center!important;justify-content:center!important;font:1000 clamp(13px,1.8vw,23px)/1 system-ui,sans-serif!important;color:#fff!important;text-shadow:0 2px 5px #000!important;white-space:nowrap!important;">'+score+'</div>'+
      '</div>';
    }).join('')+
    '</div></div>';
