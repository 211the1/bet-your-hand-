...
function renderHostFinishScreen(game){
  ...
  const slotTops=['72.8%','72.8%','72.8%','72.8%','72.8%'];
  const slotWidths=['12%','12%','12%','12%','12%'];
  const slotHeights=['20%','20%','20%','20%','20%'];
  ...
  overlay.innerHTML='<div class="host-finish-art-lock" style="position:relative!important;width:100%!important;height:100%!important;inset:0!important;overflow:hidden!important;">'+
    '<img src="/finish-screen.png?v=10" alt="" style="position:absolute!important;inset:0!important;width:100%!important;height:100%!important;display:block!important;object-fit:fill!important;pointer-events:none!important;">'+
    ...
    scores.slice(0,5).map((p,i)=>{
      ...
      return '<div class="host-finish-slot" data-slot="'+i+'" style="position:absolute!important;left:'+columns[i]+'!important;top:'+slotTops[i]+'!important;width:'+slotWidths[i]+'!important;height:'+slotHeights[i]+'!important;margin:0!important;padding:0!important;box-sizing:border-box!important;text-align:center!important;overflow:visible!important;pointer-events:none!important;">'+
        '<div class="host-finish-photo-slot" style="position:absolute!important;left:50%!important;top:0!important;transform:translateX(-50%)!important;width:78%!important;height:70%!important;overflow:hidden!important;border-radius:8%!important;box-sizing:border-box!important;">'+
