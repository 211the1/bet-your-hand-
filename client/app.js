...
if(m.type==='LEFT_ROOM'){joined=false;me=null;session=null;localStorage.removeItem('byhPlayerSession');try{ws?.close()}catch{}showJoinScreen(false);setStatus('YOU LEFT THE ROOM');return}
...
<div class="arcade-shell">
  <header class="arcade-header">
    ...
    <div class="arcade-logo" aria-label="PLAY YOUR HAND">PLAY YOUR HAND</div>
