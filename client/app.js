...
let ws=null,me=null,joined=false,connecting=false,retryTimer=null,pingTimer=null,session=null,autoSpinSent=false,lastSeenEvent=null,selectedCardId=null,sortMode=false,soundEnabled=true,intentionalDisconnect=false;
...
<div class="arcade-shell">
  ...
  <div class="arcade-main">
    <aside class="arcade-side left-side">${callButton}${nextPlayer}<button id="view-deck" class="arcade-side-btn" type="button">VIEW DECK</button></aside>
