...
<div class="arcade-shell">
  <header class="arcade-header">
    ...
    <div class="arcade-tools"><button id="sound-toggle" type="button">SOUND<small>SOUND</small></button><button id="menu-toggle" type="button">MENU<small>MENU</small></button></div>
  </header>
