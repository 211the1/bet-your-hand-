...
## Host table layout update (2026-09-19)
- Host screen now has a responsive dark/neon PLAY YOUR HAND oval-table layout.
- Live players populate individual seats around the table using the existing character assets; the current-turn seat gets the existing flame-style highlight.
